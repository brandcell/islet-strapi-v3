  ...
  attributes: {
    ...
    blog_content: Schema.Attribute.RichText &
      Schema.Attribute.CustomField<
        ...
        {
          licenseKey: 'eyJhbGciOiJFUzI1NiJ9..-QS5shaV8P0nFmQD210sJxHGC0p2EHFxO-KH6xSnRjute4GlRnJ78y4b8P6oAR2cJxMnzjKP0tm3yLRV6mEMkw';
          output: 'HTML';
          preset: 'rich';
        }
      >;
    ...
    completeddate: Schema.Attribute.String;
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featuredImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    full_video_id_bunny: Schema.Attribute.String;
    fullVideo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::portfolio.portfolio'
    > &
      Schema.Attribute.Private;
    productionRole: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    showcase: Schema.Attribute.Boolean;
    slug: Schema.Attribute.UID<'title'>;
    snippet_video_id_bunny: Schema.Attribute.String;
    snippetVideo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    sortOrder: Schema.Attribute.Integer;
